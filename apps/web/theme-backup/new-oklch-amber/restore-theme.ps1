# Restores the new oklch amber theme from this backup folder.
# Run from repo root: .\apps\web\theme-backup\new-oklch-amber\restore-theme.ps1
...
Write-Host ""
Write-Host "New oklch theme restored. Restart dev server and hard-refresh the browser."